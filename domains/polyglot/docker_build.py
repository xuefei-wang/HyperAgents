...
from domains.polyglot.test_spec import (
    get_test_specs_from_dataset,
    make_test_spec,
    TestSpec
)
from domains.polyglot.docker_utils import (
    cleanup_container,
    remove_image,
...
def build_container(
    ...
    try:
        ...
        # Matched-info-regime: when infra is set, the task container is
        # attached to the internal no-route network + allowlisting proxy
        # instead of the default bridge, so the agent cannot git-clone the
        # public Exercism hidden tests / .meta solutions.
