...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run ProofAutoGrader")
    ...
    output_folder = harness(
        agent_path="./baselines/imo_grading/proofautograder.py",
        output_dir="./baselines/imo_grading/outputs",
        run_id=run_id,
        domain=domain,
